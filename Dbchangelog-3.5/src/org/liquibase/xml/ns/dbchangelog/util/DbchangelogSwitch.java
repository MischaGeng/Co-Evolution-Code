...
public class DbchangelogSwitch<T> extends Switch<T>
{
	...
	protected T doSwitch(int classifierID, EObject theEObject)
	{
		switch (classifierID)
		{
			...
			case DbchangelogPackage.COLUMN_TYPE4:
			{
				...
				if (result == null) result = caseColumnType3(columnType4);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case DbchangelogPackage.OUTPUT_TYPE:
			{
			...
			case DbchangelogPackage.RENAME_SEQUENCE_TYPE:
			{
				RenameSequenceType renameSequenceType = (RenameSequenceType)theEObject;
				T result = caseRenameSequenceType(renameSequenceType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case DbchangelogPackage.SET_COLUMN_REMARKS_TYPE:
			{
				SetColumnRemarksType setColumnRemarksType = (SetColumnRemarksType)theEObject;
				T result = caseSetColumnRemarksType(setColumnRemarksType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DbchangelogPackage.SET_TABLE_REMARKS_TYPE:
			{
				SetTableRemarksType setTableRemarksType = (SetTableRemarksType)theEObject;
				T result = caseSetTableRemarksType(setTableRemarksType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Rename Sequence Type</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Rename Sequence Type</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseRenameSequenceType(RenameSequenceType object)
	{
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Set Column Remarks Type</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Set Column Remarks Type</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSetColumnRemarksType(SetColumnRemarksType object)
	{
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Set Table Remarks Type</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Set Table Remarks Type</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSetTableRemarksType(SetTableRemarksType object)
	{
		return null;
	}
