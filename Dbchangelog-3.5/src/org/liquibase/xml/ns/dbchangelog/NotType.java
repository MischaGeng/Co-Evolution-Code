 ...
 * </p>
 * <ul>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.NotType#getGroup <em>Group</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.NotType#getAnd <em>And</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.NotType#getOr <em>Or</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.NotType#getNot <em>Not</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.NotType#getDbms <em>Dbms</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.NotType#getRunningAs <em>Running As</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.NotType#getChangeSetExecuted <em>Change Set Executed</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.NotType#getTableExists <em>Table Exists</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.NotType#getColumnExists <em>Column Exists</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.NotType#getSequenceExists <em>Sequence Exists</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.NotType#getForeignKeyConstraintExists <em>Foreign Key Constraint Exists</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.NotType#getIndexExists <em>Index Exists</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.NotType#getPrimaryKeyExists <em>Primary Key Exists</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.NotType#getViewExists <em>View Exists</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.NotType#getTableIsEmpty <em>Table Is Empty</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.NotType#getRowCount <em>Row Count</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.NotType#getSqlCheck <em>Sql Check</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.NotType#getChangeLogPropertyDefined <em>Change Log Property Defined</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.NotType#getExpectedQuotingStrategy <em>Expected Quoting Strategy</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.NotType#getCustomPrecondition <em>Custom Precondition</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.NotType#getAny <em>Any</em>}</li>
 * </ul>
 *
 * @see org.liquibase.xml.ns.dbchangelog.DbchangelogPackage#getNotType()
 * @model extendedMetaData="name='not_._type' kind='elementOnly'"
 * @generated
 */
public interface NotType extends EObject
{
	 ...
	 * @see org.liquibase.xml.ns.dbchangelog.DbchangelogPackage#getNotType_Group()
	 ...
	 * @see org.liquibase.xml.ns.dbchangelog.DbchangelogPackage#getNotType_And()
	 ...
	 * @see org.liquibase.xml.ns.dbchangelog.DbchangelogPackage#getNotType_Or()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see org.liquibase.xml.ns.dbchangelog.DbchangelogPackage#getNotType_Not()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see org.liquibase.xml.ns.dbchangelog.DbchangelogPackage#getNotType_Dbms()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see org.liquibase.xml.ns.dbchangelog.DbchangelogPackage#getNotType_RunningAs()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see org.liquibase.xml.ns.dbchangelog.DbchangelogPackage#getNotType_ChangeSetExecuted()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see org.liquibase.xml.ns.dbchangelog.DbchangelogPackage#getNotType_TableExists()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see org.liquibase.xml.ns.dbchangelog.DbchangelogPackage#getNotType_ColumnExists()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see org.liquibase.xml.ns.dbchangelog.DbchangelogPackage#getNotType_SequenceExists()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see org.liquibase.xml.ns.dbchangelog.DbchangelogPackage#getNotType_ForeignKeyConstraintExists()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see org.liquibase.xml.ns.dbchangelog.DbchangelogPackage#getNotType_IndexExists()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see org.liquibase.xml.ns.dbchangelog.DbchangelogPackage#getNotType_PrimaryKeyExists()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see org.liquibase.xml.ns.dbchangelog.DbchangelogPackage#getNotType_ViewExists()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see org.liquibase.xml.ns.dbchangelog.DbchangelogPackage#getNotType_TableIsEmpty()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see org.liquibase.xml.ns.dbchangelog.DbchangelogPackage#getNotType_RowCount()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see org.liquibase.xml.ns.dbchangelog.DbchangelogPackage#getNotType_SqlCheck()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see org.liquibase.xml.ns.dbchangelog.DbchangelogPackage#getNotType_ChangeLogPropertyDefined()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see org.liquibase.xml.ns.dbchangelog.DbchangelogPackage#getNotType_ExpectedQuotingStrategy()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see org.liquibase.xml.ns.dbchangelog.DbchangelogPackage#getNotType_CustomPrecondition()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see org.liquibase.xml.ns.dbchangelog.DbchangelogPackage#getNotType_Any()
