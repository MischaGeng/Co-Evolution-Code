 ...
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.RollbackTypeImpl#getRenameSequence <em>Rename Sequence</em>}</li>
 ...
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.RollbackTypeImpl#getSetTableRemarks <em>Set Table Remarks</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.RollbackTypeImpl#getSetColumnRemarks <em>Set Column Remarks</em>}</li>
 ...
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.RollbackTypeImpl#getOutput <em>Output</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.RollbackTypeImpl#getEmpty <em>Empty</em>}</li>
...
public class RollbackTypeImpl extends MinimalEObjectImpl.Container implements RollbackType
{
	...
	{
		return getChangeSetChildren().list(DbchangelogPackage.eINSTANCE.getRollbackType_RenameSequence());
	}
	...
	{
		return getChangeSetChildren().list(DbchangelogPackage.eINSTANCE.getRollbackType_SetTableRemarks());
	}
	...
	{
		return getChangeSetChildren().list(DbchangelogPackage.eINSTANCE.getRollbackType_SetColumnRemarks());
	}
	...
	{
		return getChangeSetChildren().list(DbchangelogPackage.eINSTANCE.getRollbackType_Output());
	}
	...
	{
		return getChangeSetChildren().list(DbchangelogPackage.eINSTANCE.getRollbackType_Empty());
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
	{
		switch (featureID)
		{
			...
			case DbchangelogPackage.ROLLBACK_TYPE__RENAME_SEQUENCE:
			...
			case DbchangelogPackage.ROLLBACK_TYPE__SET_TABLE_REMARKS:
				return ((InternalEList<?>)getSetTableRemarks()).basicRemove(otherEnd, msgs);
			case DbchangelogPackage.ROLLBACK_TYPE__SET_COLUMN_REMARKS:
			...
			case DbchangelogPackage.ROLLBACK_TYPE__OUTPUT:
				return ((InternalEList<?>)getOutput()).basicRemove(otherEnd, msgs);
			case DbchangelogPackage.ROLLBACK_TYPE__EMPTY:
