 ...
 * </p>
 * <ul>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.ReplaceTypeImpl#getReplace <em>Replace</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.ReplaceTypeImpl#getWith <em>With</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReplaceTypeImpl extends MinimalEObjectImpl.Container implements ReplaceType
{
	/**
	...
	{
		return DbchangelogPackage.eINSTANCE.getReplaceType();
	}
	...
	public void setReplace(String newReplace)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DbchangelogPackage.REPLACE_TYPE__REPLACE, oldReplace, replace));
	}
	...
	public void setWith(String newWith)
	{
		...
		with = newWith;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DbchangelogPackage.REPLACE_TYPE__WITH, oldWith, with));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case DbchangelogPackage.REPLACE_TYPE__REPLACE:
				return getReplace();
			case DbchangelogPackage.REPLACE_TYPE__WITH:
				return getWith();
		}
