 ...
 * </p>
 * <ul>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.ColumnTypeImpl#getDefaultValue <em>Default Value</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.ColumnTypeImpl#getDefaultValueBoolean <em>Default Value Boolean</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.ColumnTypeImpl#getDefaultValueComputed <em>Default Value Computed</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.ColumnTypeImpl#getDefaultValueDate <em>Default Value Date</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.ColumnTypeImpl#getDefaultValueNumeric <em>Default Value Numeric</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.ColumnTypeImpl#getHeader <em>Header</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.ColumnTypeImpl#getIndex <em>Index</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.ColumnTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.ColumnTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ColumnTypeImpl extends MinimalEObjectImpl.Container implements ColumnType
{
	...
	{
		return DbchangelogPackage.eINSTANCE.getColumnType();
	}
	...
	public void setDefaultValue(String newDefaultValue)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DbchangelogPackage.COLUMN_TYPE__DEFAULT_VALUE, oldDefaultValue, defaultValue));
	}
	...
	public void setDefaultValueBoolean(Object newDefaultValueBoolean)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DbchangelogPackage.COLUMN_TYPE__DEFAULT_VALUE_BOOLEAN, oldDefaultValueBoolean, defaultValueBoolean));
	}
	...
	public void setDefaultValueComputed(String newDefaultValueComputed)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DbchangelogPackage.COLUMN_TYPE__DEFAULT_VALUE_COMPUTED, oldDefaultValueComputed, defaultValueComputed));
	}
	...
	public void setDefaultValueDate(String newDefaultValueDate)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DbchangelogPackage.COLUMN_TYPE__DEFAULT_VALUE_DATE, oldDefaultValueDate, defaultValueDate));
	}
	...
	public void setDefaultValueNumeric(String newDefaultValueNumeric)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DbchangelogPackage.COLUMN_TYPE__DEFAULT_VALUE_NUMERIC, oldDefaultValueNumeric, defaultValueNumeric));
	}
	...
	public void setHeader(String newHeader)
	{
		...
		header = newHeader;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DbchangelogPackage.COLUMN_TYPE__HEADER, oldHeader, header));
	}
	...
	public void setIndex(Object newIndex)
	{
		...
		index = newIndex;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DbchangelogPackage.COLUMN_TYPE__INDEX, oldIndex, index));
	}
	...
	public void setName(String newName)
	{
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DbchangelogPackage.COLUMN_TYPE__NAME, oldName, name));
	}
	...
	public void setType(String newType)
	{
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DbchangelogPackage.COLUMN_TYPE__TYPE, oldType, type));
	}
