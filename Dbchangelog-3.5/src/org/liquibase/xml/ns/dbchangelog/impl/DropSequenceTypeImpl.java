...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Drop Sequence Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.DropSequenceTypeImpl#getCacheSize <em>Cache Size</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.DropSequenceTypeImpl#getCatalogName <em>Catalog Name</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.DropSequenceTypeImpl#getCycle <em>Cycle</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.DropSequenceTypeImpl#getIncrementBy <em>Increment By</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.DropSequenceTypeImpl#getMaxValue <em>Max Value</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.DropSequenceTypeImpl#getMinValue <em>Min Value</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.DropSequenceTypeImpl#getOrdered <em>Ordered</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.DropSequenceTypeImpl#getSchemaName <em>Schema Name</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.DropSequenceTypeImpl#getSequenceName <em>Sequence Name</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.DropSequenceTypeImpl#getStartValue <em>Start Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DropSequenceTypeImpl extends MinimalEObjectImpl.Container implements DropSequenceType
{
	/**
	 ...
	 * @generated
	 */
	protected DropSequenceTypeImpl()
	{
		super();
	}
	...
	{
		return DbchangelogPackage.eINSTANCE.getDropSequenceType();
	}
	...
	public void setCacheSize(BigInteger newCacheSize)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DbchangelogPackage.DROP_SEQUENCE_TYPE__CACHE_SIZE, oldCacheSize, cacheSize));
	}
	...
	public void setCatalogName(String newCatalogName)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DbchangelogPackage.DROP_SEQUENCE_TYPE__CATALOG_NAME, oldCatalogName, catalogName));
	}
	...
	public void setCycle(Object newCycle)
	{
		...
		cycle = newCycle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DbchangelogPackage.DROP_SEQUENCE_TYPE__CYCLE, oldCycle, cycle));
	}
	...
	public void setIncrementBy(String newIncrementBy)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DbchangelogPackage.DROP_SEQUENCE_TYPE__INCREMENT_BY, oldIncrementBy, incrementBy));
	}
	...
	public void setMaxValue(String newMaxValue)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DbchangelogPackage.DROP_SEQUENCE_TYPE__MAX_VALUE, oldMaxValue, maxValue));
	}
	...
	public void setMinValue(String newMinValue)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DbchangelogPackage.DROP_SEQUENCE_TYPE__MIN_VALUE, oldMinValue, minValue));
	}
	...
	public void setOrdered(Object newOrdered)
	{
		...
		ordered = newOrdered;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DbchangelogPackage.DROP_SEQUENCE_TYPE__ORDERED, oldOrdered, ordered));
	}
	...
	public void setSchemaName(String newSchemaName)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DbchangelogPackage.DROP_SEQUENCE_TYPE__SCHEMA_NAME, oldSchemaName, schemaName));
	}
	...
	public void setSequenceName(String newSequenceName)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DbchangelogPackage.DROP_SEQUENCE_TYPE__SEQUENCE_NAME, oldSequenceName, sequenceName));
	}
	...
	public void setStartValue(String newStartValue)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DbchangelogPackage.DROP_SEQUENCE_TYPE__START_VALUE, oldStartValue, startValue));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case DbchangelogPackage.DROP_SEQUENCE_TYPE__CACHE_SIZE:
				return getCacheSize();
			case DbchangelogPackage.DROP_SEQUENCE_TYPE__CATALOG_NAME:
				return getCatalogName();
			case DbchangelogPackage.DROP_SEQUENCE_TYPE__CYCLE:
				return getCycle();
