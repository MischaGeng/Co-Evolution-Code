 ...
 * </p>
 * <ul>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.ParamType1Impl#getName <em>Name</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.ParamType1Impl#getValue <em>Value</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.ParamType1Impl#getValueBoolean <em>Value Boolean</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.ParamType1Impl#getValueComputed <em>Value Computed</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.ParamType1Impl#getValueDate <em>Value Date</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.ParamType1Impl#getValueNumeric <em>Value Numeric</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.ParamType1Impl#getValueSequenceCurrent <em>Value Sequence Current</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.ParamType1Impl#getValueSequenceNext <em>Value Sequence Next</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParamType1Impl extends MinimalEObjectImpl.Container implements ParamType1
{
	...
	{
		return DbchangelogPackage.eINSTANCE.getParamType1();
	}
	...
	public void setName(String newName)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DbchangelogPackage.PARAM_TYPE1__NAME, oldName, name));
	}
	...
	public void setValue(String newValue)
	{
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DbchangelogPackage.PARAM_TYPE1__VALUE, oldValue, value));
	}
	...
	public void setValueBoolean(String newValueBoolean)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DbchangelogPackage.PARAM_TYPE1__VALUE_BOOLEAN, oldValueBoolean, valueBoolean));
	}
	...
	public void setValueComputed(String newValueComputed)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DbchangelogPackage.PARAM_TYPE1__VALUE_COMPUTED, oldValueComputed, valueComputed));
	}
	...
	public void setValueDate(String newValueDate)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DbchangelogPackage.PARAM_TYPE1__VALUE_DATE, oldValueDate, valueDate));
	}
	...
	public void setValueNumeric(String newValueNumeric)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DbchangelogPackage.PARAM_TYPE1__VALUE_NUMERIC, oldValueNumeric, valueNumeric));
	}
	...
	public void setValueSequenceCurrent(String newValueSequenceCurrent)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DbchangelogPackage.PARAM_TYPE1__VALUE_SEQUENCE_CURRENT, oldValueSequenceCurrent, valueSequenceCurrent));
	}
	...
	public void setValueSequenceNext(String newValueSequenceNext)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DbchangelogPackage.PARAM_TYPE1__VALUE_SEQUENCE_NEXT, oldValueSequenceNext, valueSequenceNext));
	}
