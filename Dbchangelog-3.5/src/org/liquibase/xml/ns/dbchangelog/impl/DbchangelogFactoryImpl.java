...
public class DbchangelogFactoryImpl extends EFactoryImpl implements DbchangelogFactory
{
	...
	public EObject create(EClass eClass)
	{
		switch (eClass.getClassifierID())
		{
			...
			case DbchangelogPackage.OUTPUT_TYPE: return createOutputType();
			...
			case DbchangelogPackage.RENAME_SEQUENCE_TYPE: return createRenameSequenceType();
			...
			case DbchangelogPackage.SET_COLUMN_REMARKS_TYPE: return createSetColumnRemarksType();
			case DbchangelogPackage.SET_TABLE_REMARKS_TYPE: return createSetTableRemarksType();
	 ...
	 * @generated
	 */
	public RenameSequenceType createRenameSequenceType()
	{
		RenameSequenceTypeImpl renameSequenceType = new RenameSequenceTypeImpl();
		return renameSequenceType;
	}
	 ...
	 * @generated
	 */
	public SetColumnRemarksType createSetColumnRemarksType()
	{
		SetColumnRemarksTypeImpl setColumnRemarksType = new SetColumnRemarksTypeImpl();
		return setColumnRemarksType;
	}
	 ...
	 * @generated
	 */
	public SetTableRemarksType createSetTableRemarksType()
	{
		SetTableRemarksTypeImpl setTableRemarksType = new SetTableRemarksTypeImpl();
		return setTableRemarksType;
	}
