...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Drop View Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.DropViewTypeImpl#getCatalogName <em>Catalog Name</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.DropViewTypeImpl#getSchemaName <em>Schema Name</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.DropViewTypeImpl#getViewName <em>View Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DropViewTypeImpl extends MinimalEObjectImpl.Container implements DropViewType
{
	/**
	...
	{
		return DbchangelogPackage.eINSTANCE.getDropViewType();
	}
	...
	public void setCatalogName(String newCatalogName)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DbchangelogPackage.DROP_VIEW_TYPE__CATALOG_NAME, oldCatalogName, catalogName));
	}
	...
	public void setSchemaName(String newSchemaName)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DbchangelogPackage.DROP_VIEW_TYPE__SCHEMA_NAME, oldSchemaName, schemaName));
	}
	...
	public void setViewName(String newViewName)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DbchangelogPackage.DROP_VIEW_TYPE__VIEW_NAME, oldViewName, viewName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case DbchangelogPackage.DROP_VIEW_TYPE__CATALOG_NAME:
				return getCatalogName();
			case DbchangelogPackage.DROP_VIEW_TYPE__SCHEMA_NAME:
				return getSchemaName();
			case DbchangelogPackage.DROP_VIEW_TYPE__VIEW_NAME:
				return getViewName();
		}
