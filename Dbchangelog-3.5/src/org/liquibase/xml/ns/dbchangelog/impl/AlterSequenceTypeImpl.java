 ...
 * </p>
 * <ul>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.AlterSequenceTypeImpl#getCacheSize <em>Cache Size</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.AlterSequenceTypeImpl#getCatalogName <em>Catalog Name</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.AlterSequenceTypeImpl#getCycle <em>Cycle</em>}</li>
...
public class AlterSequenceTypeImpl extends MinimalEObjectImpl.Container implements AlterSequenceType
{
	...
	public void setCacheSize(BigInteger newCacheSize)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DbchangelogPackage.ALTER_SEQUENCE_TYPE__CACHE_SIZE, oldCacheSize, cacheSize));
	}
	...
	public void setCycle(Object newCycle)
	{
		...
		cycle = newCycle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DbchangelogPackage.ALTER_SEQUENCE_TYPE__CYCLE, oldCycle, cycle));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case DbchangelogPackage.ALTER_SEQUENCE_TYPE__CACHE_SIZE:
				return getCacheSize();
			case DbchangelogPackage.ALTER_SEQUENCE_TYPE__CATALOG_NAME:
				return getCatalogName();
			case DbchangelogPackage.ALTER_SEQUENCE_TYPE__CYCLE:
				return getCycle();
