...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Pre Conditions Type1</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.PreConditionsType1Impl#getGroup <em>Group</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.PreConditionsType1Impl#getAnd <em>And</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.PreConditionsType1Impl#getOr <em>Or</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.PreConditionsType1Impl#getNot <em>Not</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.PreConditionsType1Impl#getDbms <em>Dbms</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.PreConditionsType1Impl#getRunningAs <em>Running As</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.PreConditionsType1Impl#getChangeSetExecuted <em>Change Set Executed</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.PreConditionsType1Impl#getTableExists <em>Table Exists</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.PreConditionsType1Impl#getColumnExists <em>Column Exists</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.PreConditionsType1Impl#getSequenceExists <em>Sequence Exists</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.PreConditionsType1Impl#getForeignKeyConstraintExists <em>Foreign Key Constraint Exists</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.PreConditionsType1Impl#getIndexExists <em>Index Exists</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.PreConditionsType1Impl#getPrimaryKeyExists <em>Primary Key Exists</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.PreConditionsType1Impl#getViewExists <em>View Exists</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.PreConditionsType1Impl#getTableIsEmpty <em>Table Is Empty</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.PreConditionsType1Impl#getRowCount <em>Row Count</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.PreConditionsType1Impl#getSqlCheck <em>Sql Check</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.PreConditionsType1Impl#getChangeLogPropertyDefined <em>Change Log Property Defined</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.PreConditionsType1Impl#getExpectedQuotingStrategy <em>Expected Quoting Strategy</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.PreConditionsType1Impl#getCustomPrecondition <em>Custom Precondition</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.PreConditionsType1Impl#getAny <em>Any</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.PreConditionsType1Impl#getOnError <em>On Error</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.PreConditionsType1Impl#getOnErrorMessage <em>On Error Message</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.PreConditionsType1Impl#getOnFail <em>On Fail</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.PreConditionsType1Impl#getOnFailMessage <em>On Fail Message</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.PreConditionsType1Impl#getOnSqlOutput <em>On Sql Output</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PreConditionsType1Impl extends MinimalEObjectImpl.Container implements PreConditionsType1
{
	/**
	 ...
	 * @ordered
	 */
	protected static final OnChangeLogPreconditionErrorOrFail ON_ERROR_EDEFAULT = OnChangeLogPreconditionErrorOrFail.HALT;
	 ...
	 * @ordered
	 */
	protected OnChangeLogPreconditionErrorOrFail onError = ON_ERROR_EDEFAULT;
	 ...
	 * @ordered
	 */
	protected static final OnChangeLogPreconditionErrorOrFail ON_FAIL_EDEFAULT = OnChangeLogPreconditionErrorOrFail.HALT;
	 ...
	 * @ordered
	 */
	protected OnChangeLogPreconditionErrorOrFail onFail = ON_FAIL_EDEFAULT;
	 ...
	 * @generated
	 */
	protected PreConditionsType1Impl()
	{
		super();
	}
	...
	{
		return DbchangelogPackage.eINSTANCE.getPreConditionsType1();
	}
	...
	public FeatureMap getGroup()
	{
		if (group == null)
		{
			group = new BasicFeatureMap(this, DbchangelogPackage.PRE_CONDITIONS_TYPE1__GROUP);
		}
		return group;
	}
	...
	{
		return getGroup().list(DbchangelogPackage.eINSTANCE.getPreConditionsType1_And());
	}
	...
	{
		return getGroup().list(DbchangelogPackage.eINSTANCE.getPreConditionsType1_Or());
	}
	...
	{
		return getGroup().list(DbchangelogPackage.eINSTANCE.getPreConditionsType1_Not());
	}
	...
	{
		return getGroup().list(DbchangelogPackage.eINSTANCE.getPreConditionsType1_Dbms());
	}
	...
	{
		return getGroup().list(DbchangelogPackage.eINSTANCE.getPreConditionsType1_RunningAs());
	}
	...
	{
		return getGroup().list(DbchangelogPackage.eINSTANCE.getPreConditionsType1_ChangeSetExecuted());
	}
	...
	{
		return getGroup().list(DbchangelogPackage.eINSTANCE.getPreConditionsType1_TableExists());
	}
	...
	{
		return getGroup().list(DbchangelogPackage.eINSTANCE.getPreConditionsType1_ColumnExists());
	}
	...
	{
		return getGroup().list(DbchangelogPackage.eINSTANCE.getPreConditionsType1_SequenceExists());
	}
	...
	{
		return getGroup().list(DbchangelogPackage.eINSTANCE.getPreConditionsType1_ForeignKeyConstraintExists());
	}
	...
	{
		return getGroup().list(DbchangelogPackage.eINSTANCE.getPreConditionsType1_IndexExists());
	}
	...
	{
		return getGroup().list(DbchangelogPackage.eINSTANCE.getPreConditionsType1_PrimaryKeyExists());
	}
	...
	{
		return getGroup().list(DbchangelogPackage.eINSTANCE.getPreConditionsType1_ViewExists());
	}
	...
	{
		return getGroup().list(DbchangelogPackage.eINSTANCE.getPreConditionsType1_TableIsEmpty());
	}
	...
	{
		return getGroup().list(DbchangelogPackage.eINSTANCE.getPreConditionsType1_RowCount());
	}
	...
	{
		return getGroup().list(DbchangelogPackage.eINSTANCE.getPreConditionsType1_SqlCheck());
	}
	...
	{
		return getGroup().list(DbchangelogPackage.eINSTANCE.getPreConditionsType1_ChangeLogPropertyDefined());
	}
	...
	{
		return getGroup().list(DbchangelogPackage.eINSTANCE.getPreConditionsType1_ExpectedQuotingStrategy());
	}
	...
	{
		return getGroup().list(DbchangelogPackage.eINSTANCE.getPreConditionsType1_CustomPrecondition());
	}
	...
	{
		return (FeatureMap)getGroup().<FeatureMap.Entry>list(DbchangelogPackage.eINSTANCE.getPreConditionsType1_Any());
	}
	 ...
	 * @generated
	 */
	public void setOnError(OnChangeLogPreconditionErrorOrFail newOnError)
	{
		OnChangeLogPreconditionErrorOrFail oldOnError = onError;
		onError = newOnError == null ? ON_ERROR_EDEFAULT : newOnError;
		boolean oldOnErrorESet = onErrorESet;
		onErrorESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DbchangelogPackage.PRE_CONDITIONS_TYPE1__ON_ERROR, oldOnError, onError, !oldOnErrorESet));
	}
	...
	public void unsetOnError()
	{
		...
		onErrorESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DbchangelogPackage.PRE_CONDITIONS_TYPE1__ON_ERROR, oldOnError, ON_ERROR_EDEFAULT, oldOnErrorESet));
	}
	...
	public void setOnErrorMessage(String newOnErrorMessage)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DbchangelogPackage.PRE_CONDITIONS_TYPE1__ON_ERROR_MESSAGE, oldOnErrorMessage, onErrorMessage));
	}
	 ...
	 * @generated
	 */
	public void setOnFail(OnChangeLogPreconditionErrorOrFail newOnFail)
	{
		OnChangeLogPreconditionErrorOrFail oldOnFail = onFail;
		onFail = newOnFail == null ? ON_FAIL_EDEFAULT : newOnFail;
		boolean oldOnFailESet = onFailESet;
		onFailESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DbchangelogPackage.PRE_CONDITIONS_TYPE1__ON_FAIL, oldOnFail, onFail, !oldOnFailESet));
	}
	...
	public void unsetOnFail()
	{
		...
		onFailESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DbchangelogPackage.PRE_CONDITIONS_TYPE1__ON_FAIL, oldOnFail, ON_FAIL_EDEFAULT, oldOnFailESet));
	}
	...
	public void setOnFailMessage(String newOnFailMessage)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DbchangelogPackage.PRE_CONDITIONS_TYPE1__ON_FAIL_MESSAGE, oldOnFailMessage, onFailMessage));
	}
	...
	public void setOnSqlOutput(OnChangeLogPreconditionOnSqlOutput newOnSqlOutput)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DbchangelogPackage.PRE_CONDITIONS_TYPE1__ON_SQL_OUTPUT, oldOnSqlOutput, onSqlOutput, !oldOnSqlOutputESet));
	}
	...
	public void unsetOnSqlOutput()
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DbchangelogPackage.PRE_CONDITIONS_TYPE1__ON_SQL_OUTPUT, oldOnSqlOutput, ON_SQL_OUTPUT_EDEFAULT, oldOnSqlOutputESet));
	}
	...
	public void eSet(int featureID, Object newValue)
	{
		switch (featureID)
		{
			...
			case DbchangelogPackage.PRE_CONDITIONS_TYPE1__ANY:
				...
				return;
			case DbchangelogPackage.PRE_CONDITIONS_TYPE1__ON_ERROR:
				setOnError((OnChangeLogPreconditionErrorOrFail)newValue);
				return;
			case DbchangelogPackage.PRE_CONDITIONS_TYPE1__ON_ERROR_MESSAGE:
				setOnErrorMessage((String)newValue);
				return;
			case DbchangelogPackage.PRE_CONDITIONS_TYPE1__ON_FAIL:
				setOnFail((OnChangeLogPreconditionErrorOrFail)newValue);
				return;
			case DbchangelogPackage.PRE_CONDITIONS_TYPE1__ON_FAIL_MESSAGE:
