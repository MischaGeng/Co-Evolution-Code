 ...
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.CreateProcedureTypeImpl#isReplaceIfExists <em>Replace If Exists</em>}</li>
...
public class CreateProcedureTypeImpl extends MinimalEObjectImpl.Container implements CreateProcedureType
{
	...
	/**
	 * The default value of the '{@link #isReplaceIfExists() <em>Replace If Exists</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected static final boolean REPLACE_IF_EXISTS_EDEFAULT = false;

	/**
	 * The cached value of the '{@link #isReplaceIfExists() <em>Replace If Exists</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isReplaceIfExists()
	 * @generated
	 * @ordered
	 */
	protected boolean replaceIfExists = REPLACE_IF_EXISTS_EDEFAULT;

	/**
	 * This is true if the Replace If Exists attribute has been set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	protected boolean replaceIfExistsESet;
	 ...
	 * @generated
	 */
	public void setReplaceIfExists(boolean newReplaceIfExists)
	{
		boolean oldReplaceIfExists = replaceIfExists;
		replaceIfExists = newReplaceIfExists;
		boolean oldReplaceIfExistsESet = replaceIfExistsESet;
		replaceIfExistsESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DbchangelogPackage.CREATE_PROCEDURE_TYPE__REPLACE_IF_EXISTS, oldReplaceIfExists, replaceIfExists, !oldReplaceIfExistsESet));
	}
	 ...
	 * @generated
	 */
	public void unsetReplaceIfExists()
	{
		boolean oldReplaceIfExists = replaceIfExists;
		boolean oldReplaceIfExistsESet = replaceIfExistsESet;
		replaceIfExists = REPLACE_IF_EXISTS_EDEFAULT;
		replaceIfExistsESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DbchangelogPackage.CREATE_PROCEDURE_TYPE__REPLACE_IF_EXISTS, oldReplaceIfExists, REPLACE_IF_EXISTS_EDEFAULT, oldReplaceIfExistsESet));
	}
	 ...
	 * @generated
	 */
	public boolean isSetReplaceIfExists()
	{
		return replaceIfExistsESet;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			...
			case DbchangelogPackage.CREATE_PROCEDURE_TYPE__REPLACE_IF_EXISTS:
				return isReplaceIfExists();
	...
	public void eSet(int featureID, Object newValue)
	{
		switch (featureID)
		{
			...
			case DbchangelogPackage.CREATE_PROCEDURE_TYPE__RELATIVE_TO_CHANGELOG_FILE:
				...
				return;
			case DbchangelogPackage.CREATE_PROCEDURE_TYPE__REPLACE_IF_EXISTS:
				setReplaceIfExists((Boolean)newValue);
				return;
			case DbchangelogPackage.CREATE_PROCEDURE_TYPE__SCHEMA_NAME:
	...
	public String toString()
	{
		...
		if (replaceIfExistsESet) result.append(replaceIfExists); else result.append("<unset>");
