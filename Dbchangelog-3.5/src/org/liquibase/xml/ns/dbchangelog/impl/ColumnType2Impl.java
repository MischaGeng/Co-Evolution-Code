 ...
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.ColumnType2Impl#getComputed <em>Computed</em>}</li>
 ...
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.ColumnType2Impl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ColumnType2Impl extends MinimalEObjectImpl.Container implements ColumnType2
{
	...
	public void setComputed(Object newComputed)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DbchangelogPackage.COLUMN_TYPE2__COMPUTED, oldComputed, computed));
	}
	...
	public FeatureMap getAnyAttribute()
	{
		...
		{
			anyAttribute = new BasicFeatureMap(this, DbchangelogPackage.COLUMN_TYPE2__ANY_ATTRIBUTE);
		}
		return anyAttribute;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
	{
		switch (featureID)
		{
			...
			case DbchangelogPackage.COLUMN_TYPE2__ANY_ATTRIBUTE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			...
			case DbchangelogPackage.COLUMN_TYPE2__COMPUTED:
				return getComputed();
