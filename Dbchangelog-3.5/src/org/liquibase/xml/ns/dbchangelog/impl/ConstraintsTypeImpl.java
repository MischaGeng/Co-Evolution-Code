 ...
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.ConstraintsTypeImpl#getReferencedTableCatalogName <em>Referenced Table Catalog Name</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.ConstraintsTypeImpl#getReferencedTableName <em>Referenced Table Name</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.ConstraintsTypeImpl#getReferencedTableSchemaName <em>Referenced Table Schema Name</em>}</li>
...
public class ConstraintsTypeImpl extends MinimalEObjectImpl.Container implements ConstraintsType
{
	...
	public void setReferencedTableCatalogName(String newReferencedTableCatalogName)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DbchangelogPackage.CONSTRAINTS_TYPE__REFERENCED_TABLE_CATALOG_NAME, oldReferencedTableCatalogName, referencedTableCatalogName));
	}
	...
	public void setReferencedTableSchemaName(String newReferencedTableSchemaName)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DbchangelogPackage.CONSTRAINTS_TYPE__REFERENCED_TABLE_SCHEMA_NAME, oldReferencedTableSchemaName, referencedTableSchemaName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			...
			case DbchangelogPackage.CONSTRAINTS_TYPE__REFERENCED_TABLE_CATALOG_NAME:
			...
			case DbchangelogPackage.CONSTRAINTS_TYPE__REFERENCED_TABLE_SCHEMA_NAME:
