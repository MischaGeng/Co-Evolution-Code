 ...
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.DatabaseChangeLogTypeImpl#getContext <em>Context</em>}</li>
...
public class DatabaseChangeLogTypeImpl extends MinimalEObjectImpl.Container implements DatabaseChangeLogType
{
	...
	public void setContext(String newContext)
	{
		...
		context = newContext;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DbchangelogPackage.DATABASE_CHANGE_LOG_TYPE__CONTEXT, oldContext, context));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			...
			case DbchangelogPackage.DATABASE_CHANGE_LOG_TYPE__CONTEXT:
				return getContext();
