 ...
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.LoadUpdateDataTypeImpl#isOnlyUpdate <em>Only Update</em>}</li>
 ...
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.LoadUpdateDataTypeImpl#getRelativeToChangelogFile <em>Relative To Changelog File</em>}</li>
...
public class LoadUpdateDataTypeImpl extends MinimalEObjectImpl.Container implements LoadUpdateDataType
{
	...
	/**
	 * The default value of the '{@link #isOnlyUpdate() <em>Only Update</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isOnlyUpdate()
	 * @generated
	 * @ordered
	 */
	protected static final boolean ONLY_UPDATE_EDEFAULT = false;

	/**
	 * The cached value of the '{@link #isOnlyUpdate() <em>Only Update</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isOnlyUpdate()
	 * @generated
	 * @ordered
	 */
	protected boolean onlyUpdate = ONLY_UPDATE_EDEFAULT;

	/**
	 * This is true if the Only Update attribute has been set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	protected boolean onlyUpdateESet;
	 ...
	 * @generated
	 */
	public void setOnlyUpdate(boolean newOnlyUpdate)
	{
		boolean oldOnlyUpdate = onlyUpdate;
		onlyUpdate = newOnlyUpdate;
		boolean oldOnlyUpdateESet = onlyUpdateESet;
		onlyUpdateESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DbchangelogPackage.LOAD_UPDATE_DATA_TYPE__ONLY_UPDATE, oldOnlyUpdate, onlyUpdate, !oldOnlyUpdateESet));
	}
	 ...
	 * @generated
	 */
	public void unsetOnlyUpdate()
	{
		boolean oldOnlyUpdate = onlyUpdate;
		boolean oldOnlyUpdateESet = onlyUpdateESet;
		onlyUpdate = ONLY_UPDATE_EDEFAULT;
		onlyUpdateESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DbchangelogPackage.LOAD_UPDATE_DATA_TYPE__ONLY_UPDATE, oldOnlyUpdate, ONLY_UPDATE_EDEFAULT, oldOnlyUpdateESet));
	}
	 ...
	 * @generated
	 */
	public boolean isSetOnlyUpdate()
	{
		return onlyUpdateESet;
	}
	...
	public void setRelativeToChangelogFile(Object newRelativeToChangelogFile)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DbchangelogPackage.LOAD_UPDATE_DATA_TYPE__RELATIVE_TO_CHANGELOG_FILE, oldRelativeToChangelogFile, relativeToChangelogFile));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			...
			case DbchangelogPackage.LOAD_UPDATE_DATA_TYPE__FILE:
				return getFile();
			case DbchangelogPackage.LOAD_UPDATE_DATA_TYPE__ONLY_UPDATE:
				return isOnlyUpdate();
			case DbchangelogPackage.LOAD_UPDATE_DATA_TYPE__PRIMARY_KEY:
				return getPrimaryKey();
			case DbchangelogPackage.LOAD_UPDATE_DATA_TYPE__QUOTCHAR:
				return getQuotchar();
			case DbchangelogPackage.LOAD_UPDATE_DATA_TYPE__RELATIVE_TO_CHANGELOG_FILE:
	...
	public void eSet(int featureID, Object newValue)
	{
		switch (featureID)
		{
			...
			case DbchangelogPackage.LOAD_UPDATE_DATA_TYPE__FILE:
				...
				return;
			case DbchangelogPackage.LOAD_UPDATE_DATA_TYPE__ONLY_UPDATE:
				setOnlyUpdate((Boolean)newValue);
				return;
			case DbchangelogPackage.LOAD_UPDATE_DATA_TYPE__PRIMARY_KEY:
	...
	public String toString()
	{
		...
		result.append(", file: ");
		result.append(file);
		result.append(", onlyUpdate: ");
		if (onlyUpdateESet) result.append(onlyUpdate); else result.append("<unset>");
