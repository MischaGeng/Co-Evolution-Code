 ...
 * </p>
 * <ul>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.IncludeTypeImpl#getContext <em>Context</em>}</li>
...
public class IncludeTypeImpl extends MinimalEObjectImpl.Container implements IncludeType
{
	...
	public void setContext(String newContext)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DbchangelogPackage.INCLUDE_TYPE__CONTEXT, oldContext, context));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case DbchangelogPackage.INCLUDE_TYPE__CONTEXT:
				return getContext();
