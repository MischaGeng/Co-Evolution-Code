 ...
 * </p>
 * <ul>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.ParamTypeImpl#getMixed <em>Mixed</em>}</li>
...
public class ParamTypeImpl extends MinimalEObjectImpl.Container implements ParamType
{
	...
	public FeatureMap getMixed()
	{
		if (mixed == null)
		{
			mixed = new BasicFeatureMap(this, DbchangelogPackage.PARAM_TYPE__MIXED);
		}
		return mixed;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
	{
		switch (featureID)
		{
			case DbchangelogPackage.PARAM_TYPE__MIXED:
