 ...
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.ModifySqlTypeImpl#getLabels <em>Labels</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ModifySqlTypeImpl extends MinimalEObjectImpl.Container implements ModifySqlType
{
	...
	public void setLabels(String newLabels)
	{
		...
		labels = newLabels;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DbchangelogPackage.MODIFY_SQL_TYPE__LABELS, oldLabels, labels));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			...
			case DbchangelogPackage.MODIFY_SQL_TYPE__DBMS:
				return getDbms();
			case DbchangelogPackage.MODIFY_SQL_TYPE__LABELS:
				return getLabels();
		}
