...
public class SaveChangeLogFile
{
	public static void saveChangeLogFile(DocumentRoot docuRoot) throws Exception
	{
		String fileName = "Z:/Workspace/Co-EvolutionMMandDB/ChangeLog/InstanceMigration123.xml";
